...
\begin{recipe}[
    ...
    source = {Adapted from \cite{EssentialsOfMediterraneanCooking}}
]
{Pork Smothered in Leeks}
    ...
    \preparation{
        ...
        \step Add the tomatoes, celery and enough water to almost cover all the meat. Bring to a boil, stirring occasionally.
        ...
        \step Put the cleaned leeks in a pan, add a small layer of water, bring it to a boil and reduce to medium-low. Simmer for 10 minutes, then drain.
